                ...
                <div class="container">
                    <div class="w-full lg:flex items-center pb-10 lg:pb-0 gap-7 mt-20">
                        ...
                        <div class="mt-10 lg:mt-0 lg:w-1/2 xl:w-7/12">
                            ...
                            <p class="text-base text-gray-900 leading-7 mb-2.5">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the  standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries but also the on leap into electronic typesetting.</p>
                ...
                <div class="container">
                    <div class="flex flex-col gap-y-10 lg:flex-row items-center pb-10 lg:pb-0 gap-7 mt-20">
                        <div class="w-full lg:w-1/2 xl:w-7/12 order-last lg:order-first">
                            ...
                            <p class="text-base text-gray-800 leading-7 mb-3 text-justify ">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been thestandard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type sp also the on leap into electronic typesetting.</p>
                            <p class="text-base text-gray-800 leading-7 pb-5 text-justify">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been thestandard has survived not only five centuries but also the on leap into electronic typesetting.</p>
