        ...
        <>
            <div className="bg-white  py-8 px-7">
                <div className="flex gap-x-1.5 mb-5">
                    {
                        Array(rate).fill().map((_, id) => <AiFillStar key={index} className="text-sm text-accent" />)
                    }
                    {
                        Array(5 - rate).fill().map((_, id) => <AiFillStar key={index} className="text-sm text-gray-300" />)
                    }
                </div>
